...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('home', '0001_initial'),
        ('inventory', '0006_remove_inventory_attributes_remove_inventory_model_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_ux', models.BigIntegerField(default=1696445148)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_list', models.ManyToManyField(to='inventory.unit')),
            ],
        ),
        migrations.CreateModel(
            name='Subtypes',
        ...
        migrations.AddField(
            model_name='attributes',
            name='unit_list',
            field=models.ManyToManyField(to='inventory.unit'),
        ),
    ]
