...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('home', '0001_initial'),
        ('inventory', '0038_remove_attributes_attribute_class_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50, unique=True)),
                ('attribute_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attributes', to='inventory.attributeclass')),
            ],
        ),
        migrations.CreateModel(
            name='Make',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_ux', models.BigIntegerField(default=1698961005)),
                ('image', models.CharField(default='', max_length=100)),
                ('make', models.ManyToManyField(related_name='units', to='inventory.make')),
                ('user', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='units', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Types',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('serial_number', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=30, null=True), default=list, size=None)),
